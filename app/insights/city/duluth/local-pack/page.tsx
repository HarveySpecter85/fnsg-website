...
export const metadata = {
    ...
    description: "Local workforce data for Duluth, GA. Pay rates, shift attendance trends, and top industrial sectors.",
};

export default function DuluthLocalPackPage() {
    const jsonLd = {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "name": "First National Staffing - Duluth",
        "url": "https://firstnationalstaffing.com/insights/city/duluth/local-pack",
        "telephone": "+1-770-555-0102",
        "address": {
            "@type": "PostalAddress",
            "streetAddress": "3700 Crestwood Pkwy",
        ...
        <main className="bg-white min-h-screen">
            ...
            <div className="container mx-auto px-6 py-12 max-w-7xl">
                ...
                <div className="max-w-4xl mb-12">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mt-2 mb-6">Local Workforce Snapshot – Duluth</h1>
                    <p className="text-xl text-slate-600 leading-relaxed">
                        A focused look at the labor market dynamics in Duluth, Georgia.
                    </p>
                </div>
                ...
                <div className="bg-blue-600 text-white p-8 rounded-xl text-center">
                    <h2 className="text-2xl font-bold mb-4">Need Duluth Talent?</h2>
                ...
                <SEOBlock
                    city="Duluth"
                    keywords={['Duluth Staffing', 'Local Labor Data', 'Pay Rates Duluth', 'Industrial Workforce']}
                />
            </div>
        </main>
    );
