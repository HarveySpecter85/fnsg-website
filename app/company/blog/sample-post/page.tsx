            ...
            <div className="container mx-auto px-6 max-w-4xl py-16">
                <article className="prose prose-lg prose-slate max-w-none">
                    ...
                    <div className="bg-slate-50 p-8 rounded-xl border border-slate-200 not-prose">
                        ...
                        <Link href="/contact/general-inquiries" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
