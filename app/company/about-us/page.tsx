...
import { COMPANY_METRICS, CURRENT_YEAR } from '@/lib/site-config'
import { CheckCircle, TrendingUp, Users, Clock, ShieldCheck, Award } from 'lucide-react'

export const metadata: Metadata = {
    title: "About First National Staffing Group | Georgia's Workforce Partner",
                    ...
                    <div className="max-w-4xl">
                        ...
                        <FadeIn delay={0.5}>
                            <div className="flex flex-wrap gap-4">
                                ...
                                <MagneticButton>
                                    <Link href="/company/leadership" className="btn-secondary text-lg px-8 py-4 bg-white border border-slate-200 text-brand-navy hover:bg-slate-50">
                                        Meet Our Team
                                    </Link>
                                </MagneticButton>
                            </div>
